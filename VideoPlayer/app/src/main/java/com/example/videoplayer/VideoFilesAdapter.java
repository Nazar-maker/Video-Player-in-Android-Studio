...
public class VideoFilesAdapter extends RecyclerView.Adapter<VideoFilesAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        double millisecons = Double.parseDouble(videoList.get(position).getDuration());
        holder.videoDuration.setText(Utility.convertTime((long) millisecons));
                ...
                public void onClick(View v) {
                            ...
                            alertDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    if (rename) {
                                        ...
                                        Toast.makeText(context, "Video is renamed", Toast.LENGTH_SHORT).show();
                                        SystemClock.sleep(200);
                                        ((Activity) context).recreate();
                                    } else Toast.makeText(context, "Renaming failed", Toast.LENGTH_SHORT).show();
                                }
                            });
                    ...
                    bsView.findViewById(R.id.bs_properties).setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            String four = "Length: " + Utility.convertTime((long) millisecons);
